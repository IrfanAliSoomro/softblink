...
// class GroupFragmentBKP : Fragment(), FlexibleAdapter.OnItemClickListener, FlexibleAdapter.OnItemLongClickListener {
//
...
//                         chatIntent.putExtra("selectedTab", "group")
...
//             intent.putExtra("selectedTab", "group")
...
//         // HttpErrorHandler.handleHttpException(
//         //     context = requireContext(),
//         //     throwable = throwable,
//         //     operation = "fetching conversations",
//         //     showDialog = true
//         // )
//     }
//
...
//         fetchRooms()
//         // Note: conversationsListBottomDialog is not initialized in this fragment
//         // so we skip the dialog dismissal logic to prevent NullPointerException
//     }
//
...
//                 // Handle "Room not specified" case specifically
//                 if (throwable.message?.contains("Room not specified") == true) {
//                     // showErrorSnackbar("Please select a chat room first")
//                     // binding.searchResultsTextView.text = getString(R.string.select_room_to_search)
//                 } else {
//                     handleHttpExceptions(throwable)
//                 }
//             }
...
//
//     companion object {
//         private val TAG = GroupFragmentBKP::class.java.simpleName
