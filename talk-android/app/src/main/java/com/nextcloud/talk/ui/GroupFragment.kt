...
class GroupFragment : Fragment(), FlexibleAdapter.OnItemClickListener, FlexibleAdapter.OnItemLongClickListener {
    ...
    override fun onCreateView(
        ...
        Log.d(TAG, "GroupFragment onCreateView")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        Log.d(TAG, "GroupFragment onViewCreated")
    ...
    override fun onResume() {
        super.onResume()
        Log.d(TAG, "GroupFragment onResume")
        if (adapter == null) {
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        if (searchItem != null) {
            ...
            Log.e("GroupFragment", "action_search menu item not found!")
        }
