...
NSString * const talkAppName = @"SoftBlinks Talk";
NSString * const filesAppName = @"Nextcloud";
NSString * const copyright = @"© 2025 Nextcloud GmbH";
NSString * const bundleIdentifier = @"com.softblinks.Talk";
NSString * const groupIdentifier = @"group.com.softblinks.Talk";
NSString * const appsGroupIdentifier = @"group.com.softblinks.apps";
...
NSString * const domain = @"https://nc.softblinktech.com";
...
NSString * const brandColorHex = @"#098087";
